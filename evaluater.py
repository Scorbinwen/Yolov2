...
class VOCAPIEvaluator():
    ...
    def __init__(self, data_root, img_size, device, transform, set_type='val', year='2012', display=False):
        self.data_root = data_root
        self.img_size = img_size
        self.device = device
        self.transform = transform
        self.labelmap = config.VOC_CLASSES
    ...
    def evaluate(self, net):
        ...
        for i in range(num_images):
            ...
            t0 = time.time()
            # forward
            conf, pred_xy, pred_wh, cls_score, cls_out = net(x)
